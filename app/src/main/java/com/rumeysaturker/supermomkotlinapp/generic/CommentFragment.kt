package com.rumeysaturker.supermomkotlinapp.generic
...
import com.rumeysaturker.supermomkotlinapp.models.Comments
...
import com.rumeysaturker.supermomkotlinapp.utils.TimeAgo
...
//view işlem yapılan her zaman değişen veri girilen alan, s ise girilen değer
                            ...
                            if(p0!!.getValue() != null){
                                ...
                                for (user in p0!!.children){
                                    ...
                                    var adiSoyadi=okunanuser!!.adi_soyadi.toString()
                                        ...
                                        var profilPicture = if (!photo.isNullOrEmpty()) photo else "https://www.webtekno.com/images/editor/default/0001/29/0c2ab84a6be711f60abfc83c8612d56e340df22f.jpeg"
    ...
    class CommentViewHolder(itemView: View?) : RecyclerView.ViewHolder(itemView!!) {
        ...
        private fun kullaniciBilgileriniGetir(user_id: String?, yorum: String?) {
            ...
            mRef.child("users").child(user_id!!).addListenerForSingleValueEvent(object : ValueEventListener{
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    //yorumu gösterirken kullanıcı adı siyah yapmak için htmtl
                    var userNameveYorum="<font color=#000>"+ p0!!.getValue(Users::class.java)!!.user_name!!.toString()+"</font>" + " " + yorum
                    var sonuc:Spanned?=null
                    if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.N){//çalıştırdığımız cihazın sdk's N(Nugget)tan büyükse ki API 24 e denk gelir kendisi
            ...
            mRef.child("begenenler").addListenerForSingleValueEvent(object :ValueEventListener{
                ...
                override fun onDataChange(p0: DataSnapshot) {
                    ...
                    if(p0!!.exists()){
                        ...
                        yorumBegenmeSayisi.text=p0!!.childrenCount.toString()+" beğenme"//kaş kişi beğenmişse
                    }else {
                        yorumBegenmeSayisi.visibility=View.INVISIBLE//hiç beğenme yoksa
                    }
