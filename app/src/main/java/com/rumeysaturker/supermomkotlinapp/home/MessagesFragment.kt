...
//import com.rumeysaturker.supermomkotlinapp.utils.KonusmalarRecyclerAdapter
   ...
   // lateinit var myAdapter: KonusmalarRecyclerAdapter
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        myFragmentView.searchview.setOnClickListener {
            ...
            var intent = Intent(activity, AlgoliaSearchActivity::class.java).addFlags(Intent.FLAG_ACTIVITY_NO_ANIMATION)
