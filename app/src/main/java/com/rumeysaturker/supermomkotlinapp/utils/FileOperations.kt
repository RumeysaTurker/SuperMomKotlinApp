...
import com.rumeysaturker.supermomkotlinapp.profile.YukleniyorFragment
...
class FileOperations {
    ...
    companion object {//bu sınıftan herhangi bir nesne üretmeden burada bulunan metodu çağırabiliyoruz=static kavramına denk gelir
        ...
        fun klasordekiDosyalariGetir(klasorAdi:String):ArrayList<String>{
            ...
            //parametre olarak gönderdiğimiz klasordeki tüm dosyalar alınır
            ...
            if(klasordekiTumDosyalar != null){
                ...
                if(klasordekiTumDosyalar.size>1){
                    ...
                    Arrays.sort(klasordekiTumDosyalar, object : Comparator<File>{
                        override fun compare(o1: File?, o2: File?): Int {
                           //son eklenme güncellenme tarihine göre ayarlıyoruz
                            if(o1!!.lastModified() > o2!!.lastModified()){
                                return -1//son eklenen en başa gelir(-10 da yazabilirdik - olması yeterli)
                            }else return 1//(burası+ olmalı)
               ...
               //sıfırdan başlayıp bir eksiğine kadar okuma(index bound out of exception olmaması için -1)
